Read the supergraph-compact.txt file to get a high-level understanding of the entire codebase architecture — modules, schemas, flows, and cross-package edges in one compressed view.
